...
public class KM200Modul
{
	...
	private readonly byte[] Salt = [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00];
	...
	private byte[] Key(string unitPassword, string gatewayPassword)
	{
		...
		//using (var Md5 = new  MD5CryptoServiceProvider()) .Net 8.0 Obsolate // hex: 0000000000 key1.ComputeHash(l1.ToArray) ' byte():	
		//{
